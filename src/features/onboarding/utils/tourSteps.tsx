...
// const newPageObjectNextClick = (refs: Record<OnboardingStep, StepRef>) => {
//   console.log('newPageObjectNextClick');
//   console.log(refs[OnboardingStep.NewPageObject]?.onClickNext);
//   console.log('all refs: ', refs);

//   return refs[OnboardingStep.NewPageObject]?.onClickNext;
// };
...
//     onClick: newPageObjectNextClick(refs),
//   },
// });
...
// export const getPOPageSteps = (
//   refs: Record<OnboardingStep, StepRef>,
