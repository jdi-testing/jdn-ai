...
import CheckedEdited from "./checked-edited.svg";
...
export const VALIDATION_ERROR_MESSAGES = {
  [VALIDATION_ERROR_TYPE.DUPLICATED_LOCATOR]:
    "The locator for this element already exists.", // warn
  [VALIDATION_ERROR_TYPE.EMPTY_VALUE]: "The locator was not found on the page.",
  [VALIDATION_ERROR_TYPE.MULTIPLE_ELEMENTS]:
    " elements were found with this locator.", // warn
  [VALIDATION_ERROR_TYPE.NEW_ELEMENT]:
    "The locator leads to a new element on the page after editing.", // success
...
const isValidLocator = (validity) =>
  !validity?.locator.length ||
  validity.locator === VALIDATION_ERROR_TYPE.NEW_ELEMENT;
...
export const LocatorIcon = ({ validity, locator, deleted }) => {
  ...
  const deletedIcon = (
    <Trash size={14} color="#9a9da9" className="jdn__locatorsList-status" />
  );
