...
export const FilterHeader: React.FC<Props> = ({ onClickClose }) => (
  <React.Fragment>
    {/* copy of antd's Modal close button */}
        ...
        <span role="img" aria-label="close" className="anticon anticon-close ant-modal-close-icon">
          ...
          >
            <path
              ...
              191.7c-3-3.6-7.5-5.7-12.3-5.7H203c-6.8 0-10.5 7.9-6.1 13.1L459.4 512 196.9 824.9A7.95 7.95 0 00203 
              838h79.8c4.7 0 9.2-2.1 12.3-5.7l216.5-258.1 216.5 258.1c3 3.6 7.5 5.7 12.3 5.7h79.8c6.8 0 10.5-7.9 
              6.1-13.1L563.8 512z`}
            ></path>
          </svg>
        </span>
