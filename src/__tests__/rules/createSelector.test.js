...
import { ruleMock1, ruleMock2, ruleMock3, ruleMock4, ruleMock5, ruleMock6 } from "./__mocks__/ruleMocks";
...
test("create correct selector", () => {
  ...
  expect(createSelector(ruleMock6)).toBe(".v-select:not([class*='v-autocomplete']):not([class*='v-overflow-btn'])");
});
