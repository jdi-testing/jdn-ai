  ...
  const renderGenerationOption = (element_id, locator) => {
    if (locator.taskStatus === "PENDING" || locator.taskStatus === "STARTED") {
      return {
        ...
        icon: `<svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M9.375 1.875H7.6875C7.48039 1.875 7.3125 2.04289 7.3125 2.25V9.75C7.3125 9.95711 7.48039 10.125 7.6875 10.125H9.375C9.58211 10.125 9.75 9.95711 9.75 9.75V2.25C9.75 2.04289 9.58211 1.875 9.375 1.875Z" stroke="#5A5A5A" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M4.3125 1.875H2.625C2.41789 1.875 2.25 2.04289 2.25 2.25V9.75C2.25 9.95711 2.41789 10.125 2.625 10.125H4.3125C4.51961 10.125 4.6875 9.95711 4.6875 9.75V2.25C4.6875 2.04289 4.51961 1.875 4.3125 1.875Z" stroke="#5A5A5A" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>`,
        events: {
          click: () =>
            sendMessage({
    ...
    if (locator.taskStatus === "REVOKED") {
      return {
        ...
        icon: `<svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M10.6922 5.68125L3.94687 1.55625C3.89009 1.52122 3.82499 1.50198 3.75829 1.5005C3.69159 1.49903 3.6257 1.51537 3.56743 1.54786C3.50915 1.58034 3.4606 1.62778 3.42677 1.68529C3.39294 1.74279 3.37507 1.80828 3.375 1.875V10.125C3.37507 10.1917 3.39294 10.2572 3.42677 10.3147C3.4606 10.3722 3.50915 10.4197 3.56743 10.4521C3.6257 10.4846 3.69159 10.501 3.75829 10.4995C3.82499 10.498 3.89009 10.4788 3.94687 10.4437L10.6922 6.31875C10.7476 6.286 10.7935 6.23937 10.8254 6.18348C10.8572 6.12758 10.874 6.06435 10.874 6C10.874 5.93565 10.8572 5.87241 10.8254 5.81652C10.7935 5.76062 10.7476 5.714 10.6922 5.68125V5.68125Z" stroke="#5A5A5A" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>`,
        events: {
          click: () =>
            sendMessage({
